...
const DesignerPortfolio = () => {
  ...
  const featuredProjects = [
    {
      ...
      description: 'Comprehensive branding solution including logo, color palette, and brand guidelines',
  ...
  const testimonials = [
    {
      id: 1,
      quote: "Exceptional creativity and professionalism. Their designs transformed our brand identity completely.",
      author: "Sarah Johnson, CEO of TechInnovate",
      rating: 5
    },
    {
      id: 2,
      quote: "Precise, innovative, and always delivers beyond expectations. A true design partner.",
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white shadow-md">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white absolute top-full left-0 right-0 shadow-md">
            <a href="#home" className="block px-4 py-3 hover:bg-gray-100">Home</a>
            <a href="#portfolio" className="block px-4 py-3 hover:bg-gray-100">Portfolio</a>
      ...
      {/* Hero Section */}
      <header id="home" className="pt-24 pb-16 text-center bg-gradient-to-br from-blue-600 to-purple-700 text-white">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">Graphic Design that Tells Your Story</h1>
          <p className="text-xl mb-8">Transforming ideas into visually compelling experiences</p>
          <a 
            href="#portfolio" 
      ...
      {/* Contact Section */}
      <section id="contact" className="py-16 px-4 bg-gradient-to-br from-blue-600 to-purple-700">
